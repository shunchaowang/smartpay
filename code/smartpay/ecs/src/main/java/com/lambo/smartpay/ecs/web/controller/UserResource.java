...
import com.lambo.smartpay.ecs.web.vo.navigation.Menu;
import com.lambo.smartpay.ecs.web.vo.navigation.SubMenu;
...
public class UserResource {
    ...
    public static SecurityUser getCurrentUser() {
        ...
        if (principal instanceof UserDetails) {
            ...
            logger.debug("ecs username: " + username);
            String[] merUserStr = StringUtils.split(username, "/");
            User loginUser = userService.findUserWithMerchantByUsername(merUserStr[1],
                    merUserStr[0]);
