...
public class ShipmentStatusServiceImpl implements ShipmentStatusService {
    ...
    @Transactional
    @Override
    public ShipmentStatus create(ShipmentStatus shipmentStatus) throws MissingRequiredFieldException,
            NotUniqueException {
    ...
    @Transactional
    @Override
    public ShipmentStatus update(ShipmentStatus shipmentStatus) throws MissingRequiredFieldException,
            NotUniqueException {
