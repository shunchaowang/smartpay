...
// default order is id DESC
     ...
     */
    @Override
    public List<Return> findByCriteria(Return aReturn, String search, Integer start, Integer length, String order, ResourceProperties.JpaOrderDir orderDir, Date rangeStart, Date rangeEnd) {
        return null;
    }
