...
public class MerchantStatusServiceImpl implements MerchantStatusService {
    ...
    @Transactional
    @Override
    public MerchantStatus create(MerchantStatus merchantStatus) throws MissingRequiredFieldException,
            NotUniqueException {
    ...
    @Transactional
    @Override
    public MerchantStatus update(MerchantStatus merchantStatus) throws MissingRequiredFieldException,
            NotUniqueException {
