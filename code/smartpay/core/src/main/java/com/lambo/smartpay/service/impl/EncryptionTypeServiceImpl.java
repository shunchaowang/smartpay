...
public class EncryptionTypeServiceImpl implements EncryptionTypeService {
    ...
    @Transactional
    @Override
    public EncryptionType create(EncryptionType encryptionType) throws MissingRequiredFieldException,
            NotUniqueException {
    ...
    @Transactional
    @Override
    public EncryptionType update(EncryptionType encryptionType) throws MissingRequiredFieldException,
            NotUniqueException {
