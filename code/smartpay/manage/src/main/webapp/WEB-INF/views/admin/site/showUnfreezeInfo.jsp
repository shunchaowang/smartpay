...
<div class='row'>
    <div class='col-sm-4'>
        <h2><b>
            <spring:message code='showUnfreezeInfo.label' arguments="${entity}"/>
        </b></h2>
    </div>
</div>
<br>
...
<div class="row">
    <form:form action="${rootURL}${controller}unfreeze" method="POST"
               commandName="siteCommand" cssClass="form-horizontal" id="unfreezeSite-form">
        ...
        <div class='form-group'>
            <div class='col-sm-offset-3 col-sm-10'>
                <button class='btn btn-default' id='unfreeze-button' type="submit">
                    <spring:message code='action.unfreeze.label'/>
                </button>
                <a href="${rootURL}${controller}/showUnfreezeList">
