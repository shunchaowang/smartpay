            ...
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form:form action="${rootURL}${controller}/create" method="POST"
                               commandName="siteCommand" cssClass="form-horizontal" id="new-site-form">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <form:input size="80" path="identity" id="identity" cssClass="text"
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <form:input size="80" path="url" id="url" cssClass="text" required=""
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <form:select path="siteStatusId" id="siteStatusId" cssClass="text"
