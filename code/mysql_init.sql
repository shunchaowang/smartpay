...
CREATE TABLE IF NOT EXISTS `smartpay`.`CREDENTIALS` (
  ...
  `CRDT_CREATED_TIME` DATETIME NOT NULL,
  `CRDT_UPDATED_TIME` DATETIME NOT NULL,
...
CREATE TABLE IF NOT EXISTS `smartpay`.`FEES` (
  ...
  `FEE_CREATED_TIME` DATETIME NOT NULL,
  `FEE_UPDATED_TIME` DATETIME NOT NULL,
...
CREATE TABLE IF NOT EXISTS `smartpay`.`ENCRYPTIONS` (
  ...
  `ENCR_CREATED_TIME` DATETIME NOT NULL,
  `ENCR_UPDATED_TIME` DATETIME NOT NULL,
  ...
  UNIQUE INDEX `ENCR_KEY_UNIQUE` (`ENCR_KEY` ASC),
...
CREATE TABLE IF NOT EXISTS `smartpay`.`MERCHANTS` (
  ...
  `MCHT_CREATED_TIME` DATETIME NOT NULL,
  `MCHT_UPDATED_TIME` DATETIME NOT NULL,
...
CREATE TABLE IF NOT EXISTS `smartpay`.`ACCOUNTS` (
  ...
  `ACNT_CREATED_TIME` DATETIME NOT NULL,
  `ACNT_UPDATED_TIME` DATETIME NOT NULL,
...
CREATE TABLE IF NOT EXISTS `smartpay`.`SITES` (
  ...
  `SITE_CREATED_TIME` DATETIME NOT NULL,
  `SITE_UPDATED_TIME` DATETIME NOT NULL,
...
CREATE TABLE IF NOT EXISTS `smartpay`.`CUSTOMER_LOGINS` (
  ...
  `CSLG_CREATED_TIME` DATETIME NOT NULL,
  `CSLG_UPDATED_TIME` DATETIME NOT NULL,
...
CREATE TABLE IF NOT EXISTS `smartpay`.`CUSTOMERS` (
  ...
  `CSTM_CREATED_TIME` DATETIME NOT NULL,
  `CSTM_UPDATED_TIME` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `smartpay`.`ORDERS` (
  ...
  `ORDR_CREATED_TIME` DATETIME NOT NULL,
  `ORDR_UPDATED_TIME` DATETIME NOT NULL,
...
CREATE TABLE IF NOT EXISTS `smartpay`.`PAYMENTS` (
  ...
  `PYMT_CREATED_TIME` DATETIME NOT NULL,
  `PYMT_UPDATED_TIME` DATETIME NOT NULL,
  `PYMT_SUCCESS_TIME` DATETIME NULL,
  ...
  `PYMT_BILL_LAST_NAME` VARCHAR(32) NULL,
  ...
  `PYMT_BILL_COUNTRY` VARCHAR(32) NULL,
...
CREATE TABLE IF NOT EXISTS `smartpay`.`SHIPMENTS` (
  ...
  `SHMT_CREATED_TIME` DATETIME NOT NULL,
  `SHMT_UPDATED_TIME` DATETIME NOT NULL,
...
-- -----------------------------------------------------
-- Table `smartpay`.`ADMINISTRATORS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `smartpay`.`ADMINISTRATORS` ;
...
CREATE TABLE IF NOT EXISTS `smartpay`.`ADMINISTRATORS` (
  ...
  `ADMN_PROFILE_IMAGE` BLOB NULL,
  `ADMN_REMARK` TEXT NULL,
  `ADMN_CREATED_TIME` DATETIME NOT NULL,
  `ADMN_UPDATED_TIME` DATETIME NOT NULL,
  `ADMN_ACTIVE` TINYINT NOT NULL,
  `ADMN_ROLE_ID` BIGINT UNSIGNED NOT NULL,
  PRIMARY KEY (`ADMN_ID`, `ADMN_ROLE_ID`),
  INDEX `fk_ADMN_ROLE_idx` (`ADMN_ROLE_ID` ASC),
  UNIQUE INDEX `ADMN_ID_UNIQUE` (`ADMN_ID` ASC),
  UNIQUE INDEX `ADMN_USERNAME_UNIQUE` (`ADMN_USERNAME` ASC),
  UNIQUE INDEX `ADMN_EMAIL_UNIQUE` (`ADMN_EMAIL` ASC),
  CONSTRAINT `fk_ADMN_ROLE`
    FOREIGN KEY (`ADMN_ROLE_ID`)
...
CREATE TABLE IF NOT EXISTS `smartpay`.`RETURNS` (
  ...
  `RTRN_CREATED_TIME` DATETIME NOT NULL,
  `RTRN_UPDATED_TIME` DATETIME NOT NULL,
...
CREATE TABLE IF NOT EXISTS `smartpay`.`REFUNDS` (
  ...
  `RFND_CREATED_TIME` DATETIME NOT NULL,
  `RFND_UPDATED_TIME` DATETIME NOT NULL,
  `RFND_SUCCESS_TIME` DATETIME NULL,
...
START TRANSACTION;
USE `smartpay`;
INSERT INTO `smartpay`.`ADMINISTRATORS` (`ADMN_ID`, `ADMN_USERNAME`, `ADMN_PASSWORD`, `ADMN_FIRST_NAME`, `ADMN_LAST_NAME`, `ADMN_EMAIL`, `ADMN_PROFILE_IMAGE`, `ADMN_REMARK`, `ADMN_CREATED_TIME`, `ADMN_UPDATED_TIME`, `ADMN_ACTIVE`, `ADMN_ROLE_ID`) VALUES (NULL, 'admin', 'admin', 'Admin', 'Admin', 'ironaire@gmail.com', NULL, NULL, 'NOW()', 'NOW()', 1, 1);
