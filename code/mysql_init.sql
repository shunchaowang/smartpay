...
CREATE TABLE IF NOT EXISTS `smartpay2`.`WITHDRAWAL_SETTINGS` (
  `WDSE_ID` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `smartpay2`.`MERCHANTS` (
  ...
  `MCHT_WDSE_ID` BIGINT UNSIGNED NOT NULL,
  PRIMARY KEY (`MCHT_ID`, `MCHT_MCST_ID`, `MCHT_CRDT_ID`, `MCHT_ENCR_ID`, `MCHT_WDSE_ID`),
  ...
  INDEX `FK_MCHT_WDSE_idx` (`MCHT_WDSE_ID` ASC),
  ...
  CONSTRAINT `fk_MCHT_ENCR`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_MCHT_WDSE`
    FOREIGN KEY (`MCHT_WDSE_ID`)
    REFERENCES `smartpay2`.`WITHDRAWAL_SETTINGS` (`WDSE_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `smartpay2`.`WITHDRAWALS` (
  ...
  `WDRL_AMOUNT_APPROVED` DOUBLE NULL,
  `WDRL_REFUND_AFTER_WITHDRAWN` DOUBLE NULL,
  `WDRL_CHARGEBACK_AFTER_WITHDRAWN` DOUBLE NULL,
  `WDRL_AMOUNT_ADJUSTED` DOUBLE NULL,
...
CREATE TABLE IF NOT EXISTS `smartpay2`.`REFUNDS` (
  ...
  `RFND_WDRL_ID` BIGINT UNSIGNED NULL,
  ...
  INDEX `FK_RFND_WDRL_idx` (`RFND_WDRL_ID` ASC),
  ...
  CONSTRAINT `fk_RFND_CRCY`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_RFND_WDRL`
    FOREIGN KEY (`RFND_WDRL_ID`)
    REFERENCES `smartpay2`.`WITHDRAWALS` (`WDRL_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `smartpay2`.`CURRENCY_EXCHANGES` (
  `CREX_ID` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `CREX_CREATED_TIME` TIMESTAMP NOT NULL,
  `CREX_UPDATED_TIME` TIMESTAMP NULL,
  `CREX_REMARK` TEXT NULL,
  `CREX_ACTIVE` TINYINT NOT NULL,
  `CREX_AMOUNT_FROM` DOUBLE UNSIGNED NOT NULL,
  `CREX_AMOUNT_TO` DOUBLE UNSIGNED NOT NULL,
  `CREX_CRCY_FROM` BIGINT UNSIGNED NOT NULL,
  `CREX_CRCY_TO` BIGINT UNSIGNED NOT NULL,
  PRIMARY KEY (`CREX_ID`),
  UNIQUE INDEX `CREX_ID_UNIQUE` (`CREX_ID` ASC),
  INDEX `FK_CREX_CRCY_FROM_idx` (`CREX_CRCY_FROM` ASC),
  INDEX `FK_CREX_CRCY_TO_idx` (`CREX_CRCY_TO` ASC),
  CONSTRAINT `FK_CREX_CRCY_FROM`
    FOREIGN KEY (`CREX_CRCY_FROM`)
    REFERENCES `smartpay2`.`CURRENCIES` (`CRCY_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_CREX_CRCY_TO`
    FOREIGN KEY (`CREX_CRCY_TO`)
    REFERENCES `smartpay2`.`CURRENCIES` (`CRCY_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
INSERT INTO `smartpay2`.`MENU_CATEGORIES` (`MNCG_ID`, `MNCG_NAME`, `MNCG_INDEX`) VALUES (9, 'statisticsReport', 9);
...
INSERT INTO `smartpay2`.`MENU_ITEMS` (`MENU_ID`, `MENU_NAME`, `MENU_INDEX`, `MENU_TARGET`, `MENU_MNCG_ID`) VALUES (32, 'paymentStatistics', 91, 'report/paymentStatistics', 9);
INSERT INTO `smartpay2`.`MENU_ITEMS` (`MENU_ID`, `MENU_NAME`, `MENU_INDEX`, `MENU_TARGET`, `MENU_MNCG_ID`) VALUES (33, 'manageExchange', 74, 'currency/index/exchange', 7);
...
INSERT INTO `smartpay2`.`PERMISSIONS` (`PRMS_ID`, `PRMS_NAME`, `PRMS_DESCRIPTION`, `PRMS_ACTIVE`, `PRMS_CODE`, `PRMS_MENU_ID`) VALUES (32, 'paymentStatistics', NULL, 1, '801', 32);
INSERT INTO `smartpay2`.`PERMISSIONS` (`PRMS_ID`, `PRMS_NAME`, `PRMS_DESCRIPTION`, `PRMS_ACTIVE`, `PRMS_CODE`, `PRMS_MENU_ID`) VALUES (33, 'manageExchange', NULL, 1, '603', 33);
...
INSERT INTO `smartpay2`.`ROLE_PERMISSION_MAPPINGS` (`RPMP_ROLE_ID`, `RPMP_PRMS_ID`) VALUES (1, 32);
INSERT INTO `smartpay2`.`ROLE_PERMISSION_MAPPINGS` (`RPMP_ROLE_ID`, `RPMP_PRMS_ID`) VALUES (2, 32);
INSERT INTO `smartpay2`.`ROLE_PERMISSION_MAPPINGS` (`RPMP_ROLE_ID`, `RPMP_PRMS_ID`) VALUES (1, 33);

COMMIT;

-- -----------------------------------------------------
-- Data for table `smartpay2`.`CURRENCY_EXCHANGES`
-- -----------------------------------------------------
START TRANSACTION;
USE `smartpay2`;

INSERT INTO `smartpay2`.`CURRENCY_EXCHANGES`(`CREX_ID`, `CREX_CREATED_TIME`, `CREX_UPDATED_TIME`, `CREX_REMARK`, `CREX_ACTIVE`, `CREX_AMOUNT_FROM`, `CREX_AMOUNT_TO`, `CREX_CRCY_FROM`, `CREX_CRCY_TO`) VALUES (NULL,now(),NULL,'',1,'100','632.71','1','2');
INSERT INTO `smartpay2`.`CURRENCY_EXCHANGES`(`CREX_ID`, `CREX_CREATED_TIME`, `CREX_UPDATED_TIME`, `CREX_REMARK`, `CREX_ACTIVE`, `CREX_AMOUNT_FROM`, `CREX_AMOUNT_TO`, `CREX_CRCY_FROM`, `CREX_CRCY_TO`) VALUES (NULL,now(),NULL,'',1,'100','949.02','3','2');
INSERT INTO `smartpay2`.`CURRENCY_EXCHANGES`(`CREX_ID`, `CREX_CREATED_TIME`, `CREX_UPDATED_TIME`, `CREX_REMARK`, `CREX_ACTIVE`, `CREX_AMOUNT_FROM`, `CREX_AMOUNT_TO`, `CREX_CRCY_FROM`, `CREX_CRCY_TO`) VALUES (NULL,now(),NULL,'',1,'100','689.09','4','2');
INSERT INTO `smartpay2`.`CURRENCY_EXCHANGES`(`CREX_ID`, `CREX_CREATED_TIME`, `CREX_UPDATED_TIME`, `CREX_REMARK`, `CREX_ACTIVE`, `CREX_AMOUNT_FROM`, `CREX_AMOUNT_TO`, `CREX_CRCY_FROM`, `CREX_CRCY_TO`) VALUES (NULL,now(),NULL,'',1,'100','5.0896','5','2');
INSERT INTO `smartpay2`.`CURRENCY_EXCHANGES`(`CREX_ID`, `CREX_CREATED_TIME`, `CREX_UPDATED_TIME`, `CREX_REMARK`, `CREX_ACTIVE`, `CREX_AMOUNT_FROM`, `CREX_AMOUNT_TO`, `CREX_CRCY_FROM`, `CREX_CRCY_TO`) VALUES (NULL,now(),NULL,'',1,'100','464.92','6','2');
INSERT INTO `smartpay2`.`CURRENCY_EXCHANGES`(`CREX_ID`, `CREX_CREATED_TIME`, `CREX_UPDATED_TIME`, `CREX_REMARK`, `CREX_ACTIVE`, `CREX_AMOUNT_FROM`, `CREX_AMOUNT_TO`, `CREX_CRCY_FROM`, `CREX_CRCY_TO`) VALUES (NULL,now(),NULL,'',1,'100','440.32','7','2');
